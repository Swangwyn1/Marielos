...
const PROJECTS = [
  ...
  { title: "Playa", category: "Documental", year: "2025", client: "La Ceiba", desc: "Nostalgico y profundo bañado por la luz cálida y dorada del atardecer.", file: "dynamic-basketball-action.jpg" },
  { title: "Marathon La Prensa", category: "Sports", year: "2024", client: "Marathon", desc: "La 48 edición de la Maratón Internacional de Diario LA PRENSA, San Pedro Sula, Honduras.", file: "dynamic-basketball-motion.jpg" },
  { title: "Marathon La Prensa", category: "Sports", year: "2024", client: "Marathon", desc: "La 48 edición de la Maratón Internacional de Diario LA PRENSA, San Pedro Sula, Honduras.", file: "joyful-backyard-scene.jpg" },
  { title: "Langue, 2025", category: "Lifestyle", year: "2026", client: "Valle", desc: "Sin Descripcion.", file: "minimalist-interior-design.jpg" },
  { title: "Firma de Actas", category: "Documental", year: "2024", client: "Unitec", desc: "Sin Descripcion.", file: "minimalist-interior-ii.jpg" },
  { title: "El Valor del Detalle", category: "Documental", year: "2024", client: "Texas", desc: "Fotografía documental que inmortaliza la paciencia y precisión de un joyero en su taller, destacando el uso de herramientas de precisión y la luz puntual de trabajo.", file: "moth-in-flight.jpg" },
  { title: "Olas de Silencio", category: "Nature", year: "2023", client: "Honduras", desc: "Captura minimalista centrada en el contraste entre el plumaje detallado del ave y las ondas concéntricas sobre la superficie del agua oscura.", file: "rustic-charm-cafe.jpg" },
  { title: "Atelier Caramella", category: "B/W", year: "2024", client: "Casual", desc: "Documentando la disciplina, la técnica y el movimiento constante en el corazón de la cocina.", file: "autumn-whisper-cafe.jpg" },
  { title: "Fogon de Leña", category: "Documental", year: "2023", client: "Valle", desc: "Entre fogones y dulzura, emerge la tradición que embelesa los sentidos. ", file: "contemporary-rustic-grandeur.jpg" },
  { title: "Detras del Lente", category: "Editorial", year: "2022", client: "Honduras", desc: "Juego de encuadres y capas visuales en medio de la naturaleza, utilizando el espejo como un marco secundario para inmortalizar el acto de fotografiar en movimiento.", file: "cozy-cafe-scene.jpg" },
  { title: "Alma en Luz", category: "Portrait", year: "2024", client: "Valle", desc: "Un retrato íntimo que celebra la calidez humana, enfocándose en la expresividad genuina, las líneas de vida y la textura de la piel.", file: "serene-beachcomber.jpg" },
  { title: "Perfil Nelore", category: "Portrait", year: "2024", client: "Valle", desc: "Un primer plano de perfil en color de una vaca Nelore.", file: "serene-countertop-scene.jpg" },
  { title: "Grassland Portrait", category: "Sreet", year: "2025", client: "Honduras", desc: "Sin Descripcion.", file: "serene-grassland-portrait.jpg" },
  { title: "Raices", category: "Street", year: "2025", client: "Honduras", desc: "Retrato de carácter en escala de grises que explora la conexión cotidiana entre el hombre y el entorno rural a través de una perspectiva monumental.", file: "serene-pilates-studio.jpg" },
  { title: "Los Judios", category: "Street", year: "2024", client: "San Lorenzo", desc: "En Semana Santa, en el departamento de Valle, los judíos se reinventan año tras año, conservando una de las tradiciones más arraigadas del sur.", file: "silhouette-warm-glow.jpg" },
  { title: "Cafeto", category: "Travel", year: "2024", client: "La Paz", desc: "La planta del café, llamada oficialmente cafeto, es un arbusto tropical perenne que produce frutos rojos en forma de cereza. ", file: "silhouetted-journey.jpg" },
  { title: "Retrato Callejero Candid", category: "Street", year: "2024", client: "Honduras", desc: "Un retrato espontáneo de calle de un hombre sonriente sentado, con una gorra y tatuajes, descansando contra una persiana azul metálica bajo luz natural.", file: "tennis-action-shot.jpg" },
  { title: "Vendedora en Langue", category: "Street", year: "2024", client: "Valle", desc: "Primer plano de una mujer de mercado concentrada en su puesto, rodeada de productos frescos, con el enfoque en la textura de los pescados secos que está manipulando bajo la iluminación ambiental del mercado.", file: "tennis-victory-pose.jpg" },
  ...
  { title: "Contorsión de Estudio", category: "B/W", year: "2024", client: "Honduras", desc: "Toma de estudio dramática y de alto contraste en blanco y negro de una bailarina en pose", file: "urban-pose-fire-hydrant.jpg" },
  { title: "Boda", category: "Bodas", year: "2025", client: "Honduras", desc: "Cereminia civile de las Bodas de Caná en San Pedro Sula", file: "warm-rustic-elegance.jpg" },
  { title: "Balcones de Sal", category: "Analogo", year: "2025", client: "La Ceiba", desc: "Un estudio visual sobre la arquitectura costera de época, donde la pátina del tiempo, la gráfica marina y una palmera solitaria capturan el ritmo pausado del litoral.", file: "Kodak Portra 400_04.jpg" },
  { title: "Caos Ordenado", category: "B/W", year: "2025", client: "Honduras", desc: "Una toma abstracta y monocromática de la arquitectura moderna que desafía la gravedad, donde los volúmenes de cristal y metal apilados y en ángulo se transforman en una intrincada danza de luz y sombra.", file: "Edificio.jpg" },
  { title: "Azul y Blanco", category: "Documental", year: "2025", client: "Honduras", desc: "Una toma de alto dinamismo enfocada en el movimiento orgánico de la tela ondeando al viento.", file: "bandera.jpg" },
  { title: "Mirada Indulgente", category: "Documental", year: "2025", client: "Honduras", desc: "Un primer plano íntimo y de enfoque selectivo de un felino en un momento de pura relajación, capturando texturas y una pose lúdica que evoca una profunda sensación de comodidad y tranquilidad.", file: "Cat.jpg" },
  { title: "Ecos Urbanos", category: "Documental", year: "2025", client: "Honduras", desc: "Una exploración geométrica de la vida en la ciudad, donde las texturas industriales, las estructuras de acero oxidado y los reflejos de las ventanas de cristal crean un mosaico visual de lo urbano frente al cielo siempre cambiante.", file: "Centro.jpg" },
  { title: "Ascenso Sacro", category: "Documental", year: "2025", client: "La Ceiba", desc: "Una composición arquitectónica que se eleva hacia el cielo, uniendo la forma cónica terracota con la estructura sagrada, destacando la interacción entre la luz natural, la cruz de metal y el cielo azul.", file: "Cupula.jpg" },
  { title: "Noches de Verano", category: "Analogo", year: "2025", client: "La Ceiba", desc: "Una escena de playa evocadora al anochecer, capturada con el grano y la paleta de colores de la película analógica, donde las luces de guirnalda y las figuras distantes crean una atmósfera nostálgica y efímera.", file: "Kodak Portra 400_03.jpg" },
  { title: "Luz de Lunes", category: "Documental", year: "2025", client: "Honduras", desc: "Un estudio minimalista sobre la soledad y la inmensidad, que presenta una luna creciente aislada en el vasto lienzo de un cielo azul claro y limpio, invitando a la contemplación.", file: "Moon.jpg" },
  { title: "Red", category: "B/W", year: "2025", client: "Texas", desc: "Una toma de acción documental en blanco y negro que captura la fuerza y la gracia de un pescador lanzando una red al agua, inmortalizando el movimiento y el momento justo antes del impacto con la superficie.", file: "Red.jpg" },
  { title: "Solo", category: "B/W", year: "2025", client: "La Ceiba", desc: "Una toma de estudio dramática y de alto contraste en blanco y negro de una bailarina en pose, con una iluminación de claroscuro que resalta la forma humana, el tutú y la disciplina, creando una atmósfera de misterio y belleza pura.", file: "Bailarina.jpg" }, 
  { title: "Espacios de Espera", category: "B/W", year: "2025", client: "Texas", desc: "Una fotografía documental en blanco y negro de estilo candid que captura un momento tranquilo de aislamiento urbano, donde las luces fluorescentes de un puesto de mercado iluminan la soledad de una figura solitaria.", file: "Alone.jpg" },
  { title: "Posada Solitaria", category: "B/W", year: "2025", client: "Valle", desc: "Un estudio sobre la composición y el minimalismo en blanco y negro, donde un pájaro solitario se posa sobre un techo de tejas de terracota texturizadas, enmarcado por un cielo nublado y difuso.", file: "Bird.jpg" },
  { title: "Bitácora de Verano", category: "Street", year: "2025", client: "La Ceiba", desc: "Captura espontánea con estética de diario de viaje que inmortaliza un paseo bajo el sol cálido, la vegetación tropical y la perspectiva urbana del litoral.", file: "Kodak Portra 400_01.jpg" },
  { title: "Destellos de Orilla", category: "Street", year: "2025", client: "La Ceiba", desc: "Composición de alto contraste al anochecer, donde una guía de bombillas incandescentes guía la mirada hacia el reflejo del sol sobre la marea y las siluetas en la arena.", file: "Kodak Portra 400_02.jpg" },
  { title: "Orilla Distante", category: "Landscape", year: "2025", client: "Texas", desc: "Composición vertical que explora la textura ondulada del agua frente a la serenidad de una residencia de campo enmarcada por árboles de temporada.", file: "Texas_01.jpg" },
  { title: "Díptico de Texturas Rurales", category: "Nature", year: "2025", client: "Valle", desc: "Un díptico en blanco y negro de paisajes rurales. Muestra formaciones montañosas texturizadas y techos de tejas rurales, centrándose en la textura, la geometría y la atmósfera del lugar.", file: "Valle_02.jpg" },
  { title: "Retrato Nelore", category: "Nature", year: "2025", client: "Valle", desc: "Un retrato frontal y nítido de una vaca Nelore blanca. Su expresión serena y los grandes cuernos curvados son el foco principal, resaltando la textura del pelaje blanco contra el verde suave del prado.", file: "Valle_03.jpg" },
  { title: "Perfil Nelore en Color", category: "Nature", year: "2025", client: "Valle", desc: "Un primer plano de perfil en color de una vaca Nelore marrón. La descripción se centra en los tonos cálidos del pelaje y la valla de alambre de espino texturizada que enmarca la toma.", file: "Valle_05.jpg" },
  { title: "Atardecer Rural", category: "Nature", year: "2025", client: "Valle", desc: "Un paisaje rural abierto y profundo bañado por la luz cálida y dorada del atardecer. La descripción debe capturar la inmensidad del prado verde y los árboles, con un pequeño perro como punto de referencia en la distancia, todo bajo un cielo dorado..", file: "Valle_06.jpg" },
  { title: "Luz de Ambiente", category: "Interior", year: "2025", client: "Honduras", desc: "Un primer plano centrado en un gran letrero de neón que brilla en el interior de un local. La descripción debe destacar el contraste del neón brillante contra las paredes de madera oscura, los cuadros enmarcados y la vegetación, capturando una atmósfera de 'lugar'.", file: "Letrero.jpg" },
  { title: "Claroscuro", category: "Interior", year: "2025", client: "Honduras", desc: "Un estudio íntimo de interior que juega con el contraste dramático. La silueta oscura del espacio interior enmarca una ventana que revela un paisaje de montañas brumosas bañadas por la luz suave y dorada del atardecer..", file: "Stanza01.jpg" },
  { title: "Perspectiva Urbana", category: "Architecture", year: "2025", client: "Honduras", desc: "Una toma de ángulo picado desde un balcón que utiliza la geometría repetitiva de las barreras blancas de seguridad para enmarcar y dirigir la mirada hacia un paisaje urbano de techos rojos y vegetación que se extiende bajo un cielo azul claro.", file: "Stanza02.jpg" },
  { title: "Marathon La Prensa", category: "Street", year: "2025", client: "Honduras", desc: "La 48 edición de la Maratón Internacional de Diario LA PRENSA, San Pedro Sula, Honduras.", file: "Marathon03.jpg" },
  { title: "Alessandro", category: "LifeStyle", year: "2025", client: "Honduras", desc: "Cafe Panistro", file: "Alessandro.jpg" },
  { title: "Bitácora de Verano", category: "Documental", year: "2025", client: "Honduras", desc: "Las playas urbanas de La Ceiba, en la costa caribeña de Honduras", file: "1.jpg" },
  { title: "Alondra", category: "Portrait", year: "2024", client: "Honduras", desc: "Alondra ha sido una de mis modelos más desafiantes de fotografiar, pero también una de las más gratificantes. ", file: "Alondra.jpg" },
