...
const PROJECTS = [
  ...
  { title: "Minimalist Interior", category: "Architecture", year: "2026", client: "Form Atelier", desc: "Restrained material palette and sculptural negative space, every line intentional.", file: "minimalist-interior-design.jpg" },
  ...
  { title: "Serene Countertop", category: "Still Life", year: "2024", client: "Daybreak", desc: "A calm arrangement of everyday objects bathed in diffused morning light.", file: "serene-countertop-scene.jpg" },
  { title: "Grassland Portrait", category: "Portrait", year: "2025", client: "Field Notes", desc: "Wind-swept grasses frame a quiet figure under an open, endless sky.", file: "serene-grassland-portrait.jpg" },
  { title: "Pilates Studio", category: "Wellness", year: "2026", client: "Form Atelier", desc: "Clean light and controlled motion inside a minimalist movement studio.", file: "serene-pilates-studio.jpg" },
  { title: "Warm Glow", category: "Portrait", year: "2024", client: "Atlas Studio", desc: "A silhouette wrapped in amber light — intimacy rendered in shadow and warmth.", file: "silhouette-warm-glow.jpg" },
  { title: "Silhouetted Journey", category: "Travel", year: "2025", client: "Tideline", desc: "A lone traveler outlined against a vast, luminous horizon.", file: "silhouetted-journey.jpg" },
  { title: "Tennis Action", category: "Sports", year: "2025", client: "Court Co.", desc: "The split-second of contact — tension, focus, and explosive precision.", file: "tennis-action-shot.jpg" },
  { title: "Tennis Victory", category: "Sports", year: "2024", client: "Court Co.", desc: "Arms raised, breath held — the pure release of a hard-won point.", file: "tennis-victory-pose.jpg" },
  { title: "Terminal Traveler", category: "Documentary", year: "2025", client: "Transit", desc: "Stillness inside motion — a figure waiting amid the rhythm of departures.", file: "traveler-in-terminal.jpg" },
  { title: "Crosswalk Trio", category: "Street", year: "2024", client: "Transit", desc: "Three strangers, one instant — the choreography of a city intersection.", file: "urban-crosswalk-trio.jpg" },
  ...
  { title: "Ñuz de Lunes", category: "Documental", year: "2025", Lugar: "Honduras", desc: "Un estudio minimalista sobre la soledad y la inmensidad, que presenta una luna creciente aislada en el vasto lienzo de un cielo azul claro y limpio, invitando a la contemplación.", file: "Moon.jpg" },
  { title: "The Art of Noticing", category: "Analogo", year: "2025", Lugar: "Texas", desc: "Una toma de acción documental en blanco y negro que captura la fuerza y la gracia de un pescador lanzando una red al agua, inmortalizando el movimiento y el momento justo antes del impacto con la superficie.", file: "Red.jpg" },
  { title: "Espacios de Espera", category: "Analogo", year: "2025", Lugar: "N/A", desc: "Una fotografía documental en blanco y negro de estilo "candid" que captura un momento tranquilo de aislamiento urbano, donde las luces fluorescentes de un puesto de mercado iluminan la soledad de una figura solitaria.", file: "Alone.jpg" },
