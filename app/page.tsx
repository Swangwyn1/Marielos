...
const PROJECTS = [
  ...
  { title: "Marathon La Prensa", category: "Sports", year: "2024", client: "Court Co.", desc: "Motion blur meets precision — a kinetic portrait of speed and constant movement.", file: "dynamic-basketball-motion.jpg" },
